...
{
    [Guid("0E3E48F4-F7EA-4633-9A95-B3A0D1DC84EC")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": SplitDrawings (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");

            // Initialize AddIn members.
            _inventorServer = addInSiteObject.InventorServer;
            Automation = new SplitDrawingsAutomation(_inventorServer);
        }

        public void Deactivate()
        {
            Trace.TraceInformation(": SplitDrawings: deactivating... ");
